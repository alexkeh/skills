...
### APEX Components, Templates & UI Guidance
...
- Validation now produces structured evidence:
  - `validation-report.json`
  - `validation-transcript.log`
  - `problems.json`
  - `component-contracts/*.json`
- Validation now requires stronger evidence from:
...
### Routing, Catalogs & Intent Detection

These changes make routing files clearer and improve how user requests are classified.

- Renamed routing files to make their purpose clearer:

| Previous Name         | New Name                    |
| --------------------- | --------------------------- |
| `router-catalog.json` | `routing-catalog-main.json` |
| `load-policies.json`  | `routing-load-policy.json`  |
| `routing-index.json`  | `routing-assets-index.json` |
| `catalog.json`        | `domains-catalog.json`      |
...
### Generated Output & Workspace Discovery
